...
const sendEmail = async ( fullname,email, available,  balance, bonus, widthdrawBalance ) =>{
  ...
  const transporter =  nodemailer.createTransport({
    ...
    const mailOptions = {
      ...
      to:email,
      subject: 'Dashbaord Update',
      html: `<p>Hello  ${fullname},<br>Here are your availabe balances.<br>
      login to see your dashboard:<br>Email:${email}<br>Available balance: ${available}<br>Deposit Balance: ${balance}<br>Bonus:${bonus}<br>Widthdrawal Balance: ${widthdrawBalance}<br>You can login here: https://fxlite-market.com/loginAdmin<br>.<br>Thank you.</p>`
  }
