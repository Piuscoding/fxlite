...
const sendEmail = async ( fullname, email,  password ) =>{
  ...
  const transporter =  nodemailer.createTransport({
    ...
    const mailOptions = {
      ...
      to:email,
      subject: 'Welcome to FXLITE-MARKETS',
      html: `<p>Hello  ${fullname},<br>Thank you for registering on our site.
      Your login information:<br>Email: ${email}<br>Password: ${password}<br><br>You can login here: https://fxlite-market.com/login<br>  Contact us immediately if you did not authorize this registration.<br>Thank you.</p>`
  }
...
const depositEmail = async (  email, amount ) =>{
  ...
  const transporter =  nodemailer.createTransport({
    ...
    const mailOptions = {
      ...
      deposit detail are below Admin <br>Pending Deposit: ${amount}<br><br>Deposit status:Pending <br>You can login here: https://fxlite-market.com/loginAdmin<br> to approve the deposit.<br>Thank you.</p>`
  }
  transporter.sendMail(mailOptions, (error, info) =>{
    if(error){
        console.log(error);
  ...
  const transporter =  nodemailer.createTransport({
    ...
    const mailOptions = {
      ...
      <br>Widthdrawal wallet:${wallet}
       <br>You can login here: https://fxlite-market.com/loginAdmin<br> to approve the Widthdrawal.<br>Thank you.</p>`
  }
  transporter.sendMail(mailOptions, (error, info) =>{
    if(error){
        console.log(error);
